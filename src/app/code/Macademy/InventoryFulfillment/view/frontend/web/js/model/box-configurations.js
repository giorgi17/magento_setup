define([
    ...
    const boxConfiguration = () => {
        ...
        data.totalWeight = ko.computed(
            () =>
            data.weight() * data.numberOfBoxes()
        );

        data.billableWeight = ko.computed(() => {
            const dimensionalWeightResult = data.dimensionalWeight();
            const totalWeightResult = data.totalWeight();
            return dimensionalWeightResult > totalWeightResult ? dimensionalWeightResult : totalWeightResult;
        });
