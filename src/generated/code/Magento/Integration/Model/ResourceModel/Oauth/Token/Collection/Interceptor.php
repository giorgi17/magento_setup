...
class Interceptor extends \Magento\Integration\Model\ResourceModel\Oauth\Token\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinConsumerAsApplication');
        return $pluginInfo ? $this->___callPlugins('joinConsumerAsApplication', func_get_args(), $pluginInfo) : parent::joinConsumerAsApplication();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByAdminId');
        return $pluginInfo ? $this->___callPlugins('addFilterByAdminId', func_get_args(), $pluginInfo) : parent::addFilterByAdminId($adminId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByCustomerId');
        return $pluginInfo ? $this->___callPlugins('addFilterByCustomerId', func_get_args(), $pluginInfo) : parent::addFilterByCustomerId($customerId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByConsumerId');
        return $pluginInfo ? $this->___callPlugins('addFilterByConsumerId', func_get_args(), $pluginInfo) : parent::addFilterByConsumerId($consumerId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByType');
        return $pluginInfo ? $this->___callPlugins('addFilterByType', func_get_args(), $pluginInfo) : parent::addFilterByType($type);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterById');
        return $pluginInfo ? $this->___callPlugins('addFilterById', func_get_args(), $pluginInfo) : parent::addFilterById($tokenId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByRevoked');
        return $pluginInfo ? $this->___callPlugins('addFilterByRevoked', func_get_args(), $pluginInfo) : parent::addFilterByRevoked($flag);
    }
