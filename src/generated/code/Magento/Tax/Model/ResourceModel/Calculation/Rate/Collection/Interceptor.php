...
class Interceptor extends \Magento\Tax\Model\ResourceModel\Calculation\Rate\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinCountryTable');
        return $pluginInfo ? $this->___callPlugins('joinCountryTable', func_get_args(), $pluginInfo) : parent::joinCountryTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinRegionTable');
        return $pluginInfo ? $this->___callPlugins('joinRegionTable', func_get_args(), $pluginInfo) : parent::joinRegionTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinTitle');
        return $pluginInfo ? $this->___callPlugins('joinTitle', func_get_args(), $pluginInfo) : parent::joinTitle($store);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinStoreTitles');
        return $pluginInfo ? $this->___callPlugins('joinStoreTitles', func_get_args(), $pluginInfo) : parent::joinStoreTitles();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRateFilter');
        return $pluginInfo ? $this->___callPlugins('addRateFilter', func_get_args(), $pluginInfo) : parent::addRateFilter($rateId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'toOptionHashOptimized');
        return $pluginInfo ? $this->___callPlugins('toOptionHashOptimized', func_get_args(), $pluginInfo) : parent::toOptionHashOptimized();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOptionRates');
        return $pluginInfo ? $this->___callPlugins('getOptionRates', func_get_args(), $pluginInfo) : parent::getOptionRates();
    }
